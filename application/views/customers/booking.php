                                                    ...
                                                    <table class="table s99" style="font-size: 13px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="td2">2.98</td>
                                                            </tr>
                                                        
                                                            <tr>
                                                                <td class="td1 s40 ncl">- GST</td>
                                                                <td class="td2">2.60</td>
                                                            </tr>
                                                        
                                                        <tr>
                                                            <td class="td1 s41 ncl">- Total Charge</td>
                                                            <td class="td2">28.53</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                
                                            </div>
                                            <div id="newpost1" class="col-md-6 sd1 div_more_detail">
                                                <table class="table s99" style="font-size: 13px;">
                                                    <tbody>
                                                    <tr>
        ...
        <div id="ws-schedule-collection-div" style="display: none;">
            <div class="col-lg-5">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="shipmentRequestModel.scheduleCollection.saddress.city" maxlength="25" value="PERTH" id="form_booking_shipmentRequestModel_scheduleCollection_saddress_city" class="form-control alloptions" data-toggle="tooltip" data-placement="top" data-original-title="TOOLTIP:City">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="form-group">
