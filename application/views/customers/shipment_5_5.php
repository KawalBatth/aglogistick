 ...
 function saveqoute()
{
   ...
   // var dd = String(quote_date.getDate()).padStart(2, '0');
    ...
    var stateCode1 = $("input[name='shipmentPage.receiverAddress.state']").val();
