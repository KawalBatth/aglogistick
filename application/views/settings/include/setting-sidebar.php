    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li id="account" class="treeview">
          <a id="foo" disabled="true"><i class="fa fa-truck fa-fw"></i> <span>Ship</span>
     ...
     <ul class="sidebar-menu">
        <li id="admin" class="treeview">
           <a id="foo" disabled="true"><i class="fa fa-credit-card fa-fw"></i>Address Book
           </a>
      ...
      <ul class="sidebar-menu">
        <li id="admin" class="treeview">
           <a id="foo" disabled="true"><i class="fa fa-history fa-fw"></i>History
             </a>
      ...
      <ul class="sidebar-menu">
        <li id="admin" class="treeview">
           <a id="foo" disabled="true"><i class="fa fa-paper-plane fa-fw"></i>Quote/Job
              </a>
      ...
      <ul class="sidebar-menu">
        <li id="admin" class="treeview">
           <a id="foo" disabled="true"><i class="fa fa-cog fa-fw"></i>Settings
      ...
      <ul class="sidebar-menu">
        <li id="admin" class="treeview">
           <a id="foo" disabled="true"><i class="fa fa-flag fa-fw"></i>Help
